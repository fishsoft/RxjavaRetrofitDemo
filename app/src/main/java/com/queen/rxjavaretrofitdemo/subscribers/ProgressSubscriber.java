...
public class ProgressSubscriber<T> extends Subscriber<T> implements ProgressCancelListener {
    ...
    public ProgressSubscriber(Context context) {
        ...
        mProgressDialogHandler.setProgressCancelListener(this);
        mProgressDialogHandler.setCancelable(true);
        mProgressDialogHandler.setContent(mContent);
    }

    public void setSubscriberOnNextListener(SubscriberOnNextListener subscriberOnNextListener) {
